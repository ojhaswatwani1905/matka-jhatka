  ...
  return (
    <>
      ...
      >
        ...
        {(activeCategory === 'all' || activeCategory === 'slots') && (
          <>
            ...
            {/* Slots Arena Horizontal Scroll Snap */}
            <GameRowSection
              title="Slots Arena"
        ...
        {(activeCategory === 'all' || activeCategory === 'crash') && (
          <GameRowSection
        ...
        {(activeCategory === 'all' || activeCategory === 'matka') && (
