...
export default function RegisterPage() {
  ...
  const onFormSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      addToast({
        ...
        message: `Welcome to PlayArena, ${data.name}! Your account has been registered successfully.`,
      });
      ...
      addToast({
        ...
        message: err?.message || 'An account with this email already exists or registration failed.',
      });
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <AuthLayout
      ...
      subtitle="Register now with email and password to access games and wallet"
      activeMode="register"
    >
