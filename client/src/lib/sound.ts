// Web Audio API Synthesizer for Authentic Game Audio (No external MP3 files needed)
...
class SoundEngine {
  ...
  playWin() {
    ...
    notes.forEach((freq, index) => {
      ...
      gain.gain.setValueAtTime(0.4, this.ctx.currentTime + index * 0.1);
